                ...
                <x-table.tr>
                    ...
                    <x-table.td>
                        <x-dropdown
                            ...
                            <x-slot name="content">
                                <x-dropdown-link wire:click="$emit('editModal', {{ $phone->id }})"> <i class="fas fa-edit"></i>
                                    {{ __('Edit') }}
                                </x-dropdown-link>
                                <x-dropdown-link wire:click="$emit('deleteModal', {{ $phone->id }})"><i class="fas fa-trash-alt"></i>
                                    {{ __('Delete') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
