    ...
    <form wire:submit.prevent="subscribe">
        <div class="mb-6 relative lg:max-w-xl lg:mx-auto bg-white rounded-lg">
            <div class="relative flex flex-wrap items-center justify-between">
                ...
                <button type="submit" class="inline-block w-auto cursor-pointer hover:bg-green-600 text-white font-bold font-heading py-6 px-8 rounded-md uppercase text-center bg-green-600">
                    {{ __('Join') }}
                </button>
            </div>
        </div>
