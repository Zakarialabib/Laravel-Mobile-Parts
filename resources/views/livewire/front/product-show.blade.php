        ...
        <div itemtype="https://schema.org/Product" itemscope>
            ...
            <div class="mx-auto px-4">
                    ...
                    <div class="w-full md:w-1/2 px-4">
                        <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                            ...
                            <div>
                                <p class="inline-block mb-4 text-2xl font-bold font-heading">
                                    ...
                                    @if ($product->old_price && $product->discount != 0)
                                        <span class="bg-green-500 text-white rounded-xl px-4 py-2 text-sm ml-4">
                                            -{{ $product->discount }}%
                                        </span>
                                    @endif
                                </p>
                            ...
                            <div class="flex mb-5 pb-5 border-b">
                                ...
                                <div>
                                    @if ($product->status == 1)
                                        <a class="block hover:bg-green-600 text-center text-white font-bold font-heading py-2 px-4 rounded-md uppercase bg-green-600 cursor-pointer"
                            ...
                            <ul class="my-4 ">
                                ...
                                <li class="text-gray-500 py-1">
                                    <i class="text-blue-600 fa fa-check" aria-hidden="true"></i>
                                    {{ __('Expert with many years of experiance') }}
                                </li>
                                <li class="text-gray-500 py-1">
                                    <i class="text-blue-600 fa fa-check" aria-hidden="true"></i>
                ...
                <div x-data="{ activeTab: 'description' }" class="mx-auto px-4 border bg-white shadow-xl">
                    <div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 mb-10">
                        <div
